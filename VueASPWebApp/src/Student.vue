    ...
    <tr>
      <th>
        <div class="d-flex flex-row">
          <input class="form-control m-2" v-model="IDFilter" @input="FilterFn()" placeholder="Фильтр" style="width:100px">
          ...
          <button type="button" class="btn btn-light" @click="sortResult('ID',false)">
  ...
  <tbody>
    <tr v-for="dep in getAllStudents" :key="dep.ID">
      ...
      <td>
        ...
        <button type="button" @click="deleteClick(dep.ID)" class="btn btn-light mr-1">
